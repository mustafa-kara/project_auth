...
>
> ⏳ **The fourth, `20260902201638_admin_backend_role.sql` (Phase 6 — `admin_backend` DB role), has NOT been
...
> ⏳ **Before the dashboard shows numbers:** apply `supabase/migrations/20260902201638_admin_backend_role.sql`,
